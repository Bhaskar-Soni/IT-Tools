    ...
    <n-form label-placement="left" label-width="100">
      <div flex gap-3>
        <n-form-item label="Width (in px)" flex-1>
          <NInputNumber v-model:value="width" placeholder="SVG width..." min="1" />
        </n-form-item>
      ...
      <div flex gap-3>
        <n-form-item label="Height (in px)" flex-1>
          <NInputNumber v-model:value="height" placeholder="SVG height..." min="1" />
        </n-form-item>
      ...
      <div flex gap-3>
        <n-form-item label="Font size" flex-1>
          <NInputNumber v-model:value="fontSize" placeholder="Font size..." min="1" />
        </n-form-item>
