...
// Provide the local store instance to child components that expect Vuex injection/$store.
const instance = getCurrentInstance();
if (instance) {
  instance.appContext.config.globalProperties.$store = store;
}
provide('store', store);
provide('pomodoro-store', store);
