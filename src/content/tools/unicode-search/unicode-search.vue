...
// import unicodeNames from '@unicode/unicode-15.1.0/Names/index.js'; // TODO: Fix @unicode
// import unicodeCategories from '@unicode/unicode-15.1.0/General_Category'; // TODO: Fix @unicode
const unicodeNames = new Map<number, string>();
const unicodeCategories = new Map<number, string>();
  ...
  <div mx-auto max-w-2400px important:flex-1>
    <div mx-auto max-w-600px flex justify-center gap-3>
      ...
      <n-form-item label="Max results:" label-placement="left">
        <NInputNumber v-model:value="limit" :min="1" />
      </n-form-item>
    </div>
