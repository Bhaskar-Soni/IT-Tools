  ...
  <div>
    <c-card title="SLA to downtimes" mb-2>
      <n-form-item label="Agreed SLA" label-placement="left">
        <NInputNumber v-model:value="inputSLA" :min="0" :max="100" />
      </n-form-item>
    ...
    <c-card title="Weekdays hours">
      <div flex flex-wrap gap-1>
        <n-form-item label="Monday" flex-1>
          <NInputNumber v-model:value="daysHours.mon" :min="0" :max="24" />
        </n-form-item>
        <n-form-item label="Tuesday" flex-1>
          <NInputNumber v-model:value="daysHours.tue" :min="0" :max="24" />
        </n-form-item>
        <n-form-item label="Wednesday" flex-1>
          <NInputNumber v-model:value="daysHours.wed" :min="0" :max="24" />
        </n-form-item>
        <n-form-item label="Thursday" flex-1>
          <NInputNumber v-model:value="daysHours.thu" :min="0" :max="24" />
        </n-form-item>
        <n-form-item label="Friday" flex-1>
          <NInputNumber v-model:value="daysHours.fri" :min="0" :max="24" />
        </n-form-item>
      </div>
      <div flex flex-wrap gap-1>
        <n-form-item label="Saturday" flex-1>
          <NInputNumber v-model:value="daysHours.sat" :min="0" :max="24" />
        </n-form-item>
        <n-form-item label="Sunday" flex-1>
          <NInputNumber v-model:value="daysHours.sun" :min="0" :max="24" />
        </n-form-item>
      </div>
    </c-card>
  </div>
