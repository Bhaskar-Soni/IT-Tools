    ...
    <c-card>
      <n-space>
        <n-form-item :label="`Words (${words})`" label-placement="left">
          ...
          <NInputNumber v-model:value="words" size="small" />
        </n-form-item>
        <n-form-item label="Add numbers after X words" label-placement="left">
          ...
          <NInputNumber v-model:value="numbers" :max="words" size="small" />
        </n-form-item>
      </n-space>

      <n-space>
        <n-form-item label="Max passphrase len" label-placement="left">
          <NInputNumber v-model:value="maxLen" size="small" />
        </n-form-item>
      ...
      <n-form-item label="Number of passphrase to generate" label-placement="left">
        <NInputNumber v-model:value="count" size="small" />
      </n-form-item>
