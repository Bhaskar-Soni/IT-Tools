...
<template>
  ...
  >
    ...
    <textarea
      ...
      w-full
      spellcheck="false"
      class="unicode-formatter-textarea"
      style="font-family: 'Open Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;"
    />
...
.unicode-formatter-textarea:focus {
  outline: none;
  border-color: #3b4a5c;
  box-shadow: 0 0 0 2px rgba(56, 139, 253, 0.15);
}

.unicode-formatter-textarea::placeholder {
  color: #8b949e;
}
</style>
