...
<template>
  <div>
    ...
    <div mb-2 flex items-center>
      <span w-100px>Length</span>
      <NInputNumber v-model:value="length" flex-1 :min="1" :max="100" placeholder="NanoId Length" />
    </div>
    <div mb-2 flex items-center>
      <span w-100px>Quantity</span>
      <NInputNumber v-model:value="count" flex-1 :min="1" :max="50" placeholder="NanoIds quantity" />
    </div>
