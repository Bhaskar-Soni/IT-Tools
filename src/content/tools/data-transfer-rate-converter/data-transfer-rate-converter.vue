...
<template>
  <div>
    <n-p text-center>
      1MiB = 1024KiB ; 1MB = 1000kB ; 1GiB = 1024MiB ; 1GB = 1000MB ;<n-a href="https://en.wikipedia.org/wiki/Byte" target="_blank" rel="noopener">
    ...
    <c-card title="Transfer Bit Rate/Speed" mb-2>
      ...
      <n-form-item label="Duration (h/m/s):" label-placement="left">
        <NInputNumber v-model:value="transferSpeedRateInput.hours" mr-1 placeholder="Hours" :min="0" w-full />
        <NInputNumber v-model:value="transferSpeedRateInput.minutes" mr-1 placeholder="Minutes" :min="0" w-full />
        <NInputNumber v-model:value="transferSpeedRateInput.seconds" mr-1 placeholder="Seconds" :min="0" w-full />
      </n-form-item>
    ...
    <c-card title="Amount Transferable" mb-2>
      ...
      <n-form-item label="Duration (h/m/s):" label-placement="left">
        <NInputNumber v-model:value="amountTransferableInput.hours" mr-1 placeholder="Hours" :min="0" w-full />
        <NInputNumber v-model:value="amountTransferableInput.minutes" mr-1 placeholder="Minutes" :min="0" w-full />
        <NInputNumber v-model:value="amountTransferableInput.seconds" mr-1 placeholder="Seconds" :min="0" w-full />
      </n-form-item>
