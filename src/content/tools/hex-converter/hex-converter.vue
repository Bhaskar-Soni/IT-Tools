...
// import { packArray, packString, unpackArray, unpackString } from 'byte-data'; // TODO: Fix byte-data
const packArray = () => '';
const packString = () => '';
const unpackArray = () => [];
const unpackString = () => '';
      ...
      <c-card title="Hex Options" mb-1>
        ...
        <n-space v-if="decodeAs !== 'utf8'" align="baseline" justify="center">
          <n-form-item label="Bits:" label-placement="left">
            <NInputNumber v-model:value="bits" :min="1" style="width: 6em" />
          </n-form-item>
          <n-form-item>
      ...
      <c-card title="Hex Encoding Output" mt-1>
        <n-space align="baseline" justify="center">
          ...
          <n-form-item label="Group by" label-placement="left">
            <NInputNumber v-model:value="grouping" :min="0" style="width: 6em" mr-1 />digits (0 = no grouping)
          </n-form-item>
          <n-form-item label="Split as rows by" label-placement="left">
            <NInputNumber v-model:value="rowlength" :min="0" style="width: 6em" mr-1 />group of digits (0 = no rows)
          </n-form-item>
        </n-space>
      </c-card>
    </div>
      ...
      <c-card title="Struct Definition">
        ...
        <details>
          ...
          <n-p>
            ...
            <br>can prefix integer with 0x or 0b to display as hex and binary
          </n-p>
        </details>
      </c-card>
