...
const baseUrl = useQueryParamOrStorage({
  name: 'url',
  storageName: 'apiTesterUrl',
  defaultValue: '',
});

const method = useQueryParamOrStorage({
  name: 'method',
  storageName: 'api-tester:m',
  defaultValue: 'POST',
});
...
const body = useQueryParamOrStorage({
  name: 'body',
  storageName: 'api-tester:body',
  defaultValue: '',
});
