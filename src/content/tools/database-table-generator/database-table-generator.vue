    ...
    <NForm label-placement="left" label-width="180px">
      ...
      <n-dynamic-input v-model:value="table.columns" :on-create="addColumn" show-sort-button>
          ...
          <template #default="{ value: col }">
            <div class="dbtg-row">
              <NInput v-model:value="col.name" placeholder="Column name" class="dbtg-col-name" />
              <NSelect v-model:value="col.type" :options="dialectTypes[dbType].map(t => ({ label: t, value: t }))" class="dbtg-col-type" />
              ...
              <NInput v-model:value="col.defaultValue" placeholder="Default value" class="dbtg-col-default" />
            </div>
          </template>
        </n-dynamic-input>
      </c-card>
