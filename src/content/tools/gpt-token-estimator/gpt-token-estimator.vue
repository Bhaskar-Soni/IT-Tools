...
<template>
  <div>
    ...
    <div v-if="!outputTokenCosts.error">
      <n-form-item label="Used Tokens:" label-placement="left">
        <InputCopyable :value="outputTokenCosts.usedTokens" />
      </n-form-item>
      <n-form-item label="Prompt Tokens:" label-placement="left">
        <InputCopyable :value="outputTokenCosts.promptUsedTokens" />
      </n-form-item>
      <n-form-item label="Completion Tokens:" label-placement="left">
