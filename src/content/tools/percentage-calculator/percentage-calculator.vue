    ...
    <div style="margin: 0 auto; max-width: 600px">
      <c-card mb-3>
        ...
        <div flex gap-2>
          ...
          <NInputNumber v-model:value="percentageX" data-test-id="percentageX" placeholder="X" />
          <div min-w-fit pt-1>
            % of
          </div>
          <NInputNumber v-model:value="percentageY" data-test-id="percentageY" placeholder="Y" />
      ...
      <c-card mb-3>
        ...
        <div flex gap-2>
          <NInputNumber v-model:value="numberX" data-test-id="numberX" placeholder="X" />
          <div hidden min-w-fit pt-1 sm:block>
            is what percent of
          </div>
          <NInputNumber v-model:value="numberY" data-test-id="numberY" placeholder="Y" />
      ...
      <c-card mb-3>
        ...
        <div flex gap-2>
          <NInputNumber v-model:value="numberFrom" data-test-id="numberFrom" placeholder="From" />
          <NInputNumber v-model:value="numberTo" data-test-id="numberTo" placeholder="To" />
