...
<template>
  <div>
    ...
    <div flex justify-center>
      <c-button mb-1 :disabled="!file || !pdfReady" @click="processPDF">
        Extract text
      </c-button>
    </div>

    <div mb-1 mt-3 flex justify-center>
      <c-alert v-if="pdfInitError" type="error">
        {{ pdfInitError }}
      </c-alert>
    ...
    <c-card v-if="file && text" title="Output">
      ...
      <textarea-copyable label= 'Text:' :value="text" mb-1 download-file-name="output.txt" />
