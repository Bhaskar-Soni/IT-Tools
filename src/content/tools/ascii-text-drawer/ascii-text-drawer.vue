...
<template>
  <c-card>
    <c-input-text
      ...
      rows="4"
    />
    <c-select v-model:value="language" :options="languagesOptions" :searchable="true" mt-3 />
    ...
    <n-grid cols="4" x-gap="12" w-full>
      ...
      <n-gi span="2">
        <n-form-item label="Width:" label-placement="top" label-width="100" :show-feedback="false">
          <NInputNumber v-model:value="width" min="0" max="10000" w-full placeholder="Width of the text" />
        </n-form-item>
      </n-gi>
    </n-grid>
