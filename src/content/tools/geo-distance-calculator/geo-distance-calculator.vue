    ...
    <c-card title="Distance computer" mb-2>
      <n-form-item label="Geolocation 1 (latitude, longitude):">
        <n-space justify="space-between">
          <NInputNumber v-model:value="latitude1" :min="-90" :max="90" placeholder="Latitude..." />
          <NInputNumber v-model:value="longitude1" :min="-180" :max="180" placeholder="Longitude..." />
        </n-space>
      </n-form-item>
      <n-form-item label="Geolocation 2 (latitude, longitude):" gap-2>
        <n-space justify="space-between">
          <NInputNumber v-model:value="latitude2" :min="-90" :max="90" placeholder="Latitude..." />
          <NInputNumber v-model:value="longitude2" :min="-180" :max="180" placeholder="Longitude..." />
        </n-space>
      </n-form-item>
