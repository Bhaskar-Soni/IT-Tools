      ...
      <c-card>
        <n-space>
          <div>
            ...
            <n-form-item label="Output as column" label-placement="left" label-width="150" :show-feedback="false" mb-2>
          ...
          <div>
            ...
            <n-form-item label="Filter items by Regex" label-placement="left" label-width="120" :show-feedback="false" mb-2>
              <c-input-text
