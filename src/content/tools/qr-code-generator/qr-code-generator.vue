      ...
      <n-gi span="2">
        ...
        <n-form label-width="130" label-placement="left">
          ...
          <n-form-item label="Width:">
            <NInputNumber v-model:value="width" :min="0" />
          </n-form-item>
          <n-form-item label="Margin:">
            <NInputNumber v-model:value="margin" :min="0" />
          </n-form-item>
          <c-select
        ...
        <c-card title="Image" mt-3>
          ...
          <n-form label-width="130" label-placement="left" mt-3>
            <n-form-item label="Size:">
              <NInputNumber v-model:value="imageSize" :min="0" step="0.1" />
            </n-form-item>
            <n-form-item label="Margin:">
              <NInputNumber v-model:value="imageMargin" :min="0" />
            </n-form-item>
          </n-form>
        </c-card>
        <c-card mt-3>
