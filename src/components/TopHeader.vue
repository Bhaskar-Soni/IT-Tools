...
import { Menu2, Search } from '@vicons/tabler';
...
<template>
  <header class="it-tools-top-header">
    ...
    <div class="header-left">
      ...
      <div class="logo-section">
        ...
        <div class="header-title">
          <h1>IT-Tools</h1>
          <p>Smart Utilities for Everyday Tasks</p>
        </div>
      </div>
    </div>
